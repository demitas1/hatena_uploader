...
class HatenaBlogOAuthUploader:
    def __init__(self, config_file):
        ...
        credentials = self.config_manager.get_oauth_credentials()

        self.hatena_id = credentials['hatena_id']
        self.blog_id = credentials['blog_id']
    ...
    def authenticate(self):
        """OAuth認証を実行"""
        result = self.config_manager.authenticate()
        if result:
        ...
        try:
            ...
            if response.status_code == 201:
                ...
                if response.status_code == 401:
                    ...
                    self.config_manager.save_access_token('', '')
                    self._update_credentials()
